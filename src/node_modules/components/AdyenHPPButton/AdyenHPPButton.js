...
function AdyenHPPButton({hmacKey, formData, style, title}) {
  const merchantSig = calculateMerchantSignature(hmacKey, formData)
  return (
      <div>
        <form method='post' action='https://live.adyen.com/hpp/pay.shtml' id='adyenForm' name='adyenForm' target='_parent'>
        {/* <form method='post' action='https://ca-test.adyen.com/ca/ca/skin/checkhmac.shtml' id='adyenForm' name='adyenForm' target='_parent'> */}
